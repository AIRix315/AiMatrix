 ...
 *
 * Phase 7 H01.2: 将NovelVideoFields从TypeScript类型迁移为JSON Schema
 * 这些Schema将在插件初始化时注册到SchemaRegistry
 */

import type { AssetSchemaDefinition } from '../types/schema';
 ...
 * Schema ID常量（用于代码中引用）
 */
export const NovelVideoSchemaIds = {
  CHAPTER: 'novel-video.chapter',
  SCENE: 'novel-video.scene',
  CHARACTER: 'novel-video.character',
  STORYBOARD: 'novel-video.storyboard',
  VOICEOVER: 'novel-video.voiceover'
} as const;
